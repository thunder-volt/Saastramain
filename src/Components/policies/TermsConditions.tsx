  ...
  return (
    <body>
      <VStack p={10} alignItems={"stretch"}>
        <Heading alignSelf={"center"} fontSize={40} fontWeight={"bold"} pb={10}>TERMS &amp; CONDITIONS</Heading>
        <Text>Welcome to Shaastra 2023!</Text>
        <Text>
          ‘SHAASTRA’ here refers to the Technical fest conducted by IIT Madras.
        </Text>
        <Text>
        ...
        <Text>
          ...
          conditions. Do not continue to use Shaastra 2023 if you do not agree to
        ...
        <br />
        <Text>
          We employ the use of cookies. By accessing Shaastra2023, you agreed to
          use cookies in agreement with the privacy policy of SHAASTRA.
        </Text>
        <Text>
        ...
        <Text>
          Unless otherwise stated, SHAASTRA IITM and/or its licensors own the
          intellectual property rights for all material on Shaastra2023. All
          intellectual property rights are reserved. You may access this from
          Shaastra2023 for your own personal use subjected to restrictions set in
          these terms and conditions.
        </Text>

        <Text>You must not:</Text>
        <ul>
          <li>Republish material from Shaastra2023</li>
          <li>Sell, rent or sub-license material from Shaastra2023</li>
          <li>Reproduce, duplicate or copy material from Shaastra2023</li>
          <li>Redistribute content from Shaastra2023</li>
        </ul>

        <Text>This Agreement shall begin on 15th December, 2021.</Text>
        <br />
        <Heading fontSize={24} pt={8} fontWeight={"bold"} textAlign={"left"}>
        ...
        <Text>
          ...
          the hyperlink compensates the absence of SHAASTRA IITM; and (d) the link
        ...
        <Text>
          ...
          e-mail to SHAASTRA IITM. Please include your name, your organization
        ...
        <Text>
          No use of SHAASTRA IITM's logo or other artwork will be allowed for
          linking absent a trademark license agreement.
        </Text>
        <br />
        <Heading fontSize={28} pt={8} fontWeight={"bold"} textAlign={"left"}>
          iFrames
        </Heading>
        <br />
        <Text>
