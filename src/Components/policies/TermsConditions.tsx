...
const TermsConditions = (props: Props) => {
  ...
  <body>
      ...
      <Heading pb={10}>TERMS &amp; CONDITIONS</Heading>
      <Text>Welcome to Shaastra 2022!</Text>
      <Text>
      ...
      <Text>
        ...
        conditions. Do not continue to use Shaastra 2022 if you do not agree to
      ...
      <Text>
        We employ the use of cookies. By accessing Shaastra2022, you agreed to
      ...
      <Text>
        ...
        intellectual property rights for all material on Shaastra2022. All
        intellectual property rights are reserved. You may access this from
        Shaastra2022 for your own personal use subjected to restrictions set in
        these terms and conditions.
      </Text>

      <Text>You must not:</Text>
      <ul>
        <li>Republish material from Shaastra2022</li>
        <li>Sell, rent or sub-license material from Shaastra2022</li>
        <li>Reproduce, duplicate or copy material from Shaastra2022</li>
        <li>Redistribute content from Shaastra2022</li>
      </ul>
