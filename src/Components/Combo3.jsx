...
function Combo({ events }) {
  ...
  const filterEvents = events.filter(
    (event) => event.registrationfee === "500"
  );
  // console.log(ws1);
  ...
  return (
    <>
      <Card style={{ maxWidth: "30rem" }} className="offer-card">
        <Card.Body>
          <Card.Title>Phantom Combo</Card.Title>
          <Card.Text>
            Choose any <strong>Two</strong> workshops with INDIVIDUAL
            registrations from the List and get a free Hoodie at just{" "}
            <strong>Rs. 1399</strong>
          </Card.Text>
          <div className="cardButtonsContainer">
            <Button
              className="cardKnowMoreButton"
                    ...
                    <HStack>
                      <PinInput>
                        <PinInputField
                          value={pin.d1}
                          onChange={(e) =>
                            setPin({ ...pin, d1: e.target.value })
                          }
                        />
                        <PinInputField
                          value={pin.d2}
                          onChange={(e) =>
                            setPin({ ...pin, d2: e.target.value })
                          }
                        />
                        <PinInputField
                          value={pin.d3}
                          onChange={(e) =>
                            setPin({ ...pin, d3: e.target.value })
                          }
                        />
                        <PinInputField
                          value={pin.d4}
                          onChange={(e) =>
                            setPin({ ...pin, d4: e.target.value })
                          }
                        />
                        <PinInputField
                          value={pin.d5}
                          onChange={(e) =>
                            setPin({ ...pin, d5: e.target.value })
                          }
                        />
                        <PinInputField
                          value={pin.d6}
                          onChange={(e) =>
                            setPin({ ...pin, d6: e.target.value })
                          }
                        />
                      </PinInput>
                    </HStack>
                ...
                <ModalFooter>
                  <NewButton
                    ...
                    onClick={async (e) => {
                      e.preventDefault();
                      var code =
                        pin.d1 + pin.d2 + pin.d3 + pin.d4 + pin.d5 + pin.d6;
                      console.log(address);
                      await combo({
                        variables: {
                          combo: "Merry Combo",
