...
import Logo from "../Images/23_logo_R-05.png";

const Footer = (props) => {
  const emails = [
    {
      mail: "sec_cocur@smail.iitm.ac.in",
      link: "mailto:sec_cocur@smail.iitm.ac.in",
    },
    { mail: "outreach@shaastra.org", link: "mailto:outreach@shaastra.org" },
    {
      mail: "sponsorship@shaastra.org",
      link: "mailto:sponsorship@shaastra.org",
    },
        ...
        <div className="contain">
          ...
          <div className="coly logothing">
            <div className="logoFooter">
              <a className="linkylinks" href="./">
                <img
                  src={Logo}
                  alt="Shaastra 2022 Logo"
          ...
          <div className="coly">
            ...
            <ul className="emails">
              {emails.map((item) => {
                return (
                  <li>
                    <a className="linkylinks" href={item.link}>
                      {item.mail}
                    </a>
                  </li>
                );
        ...
        <p>
          <span className="add">
            ...
            {props.designed.map((item, key) => {
              if (key === 0) {
                return (
                  <a className="designedby" href={item.mail}>
                    {item.name}
                  </a>
                );
              } else {
          ...
          <div className="link-footer-div">
            <a className="linkylinks" href="./policies/Privacy" target="_blank">
              PRIVACY POLICY
            </a>{" "}
            •{" "}
            <a className="linkylinks" href="./policies/Terms" target="_blank">
              TERMS & CONDITION
            </a>{" "}
            •{" "}
            <a
            ...
            •{" "}
            <a className="linkylinks" href="./policies/Refund" target="_blank">
